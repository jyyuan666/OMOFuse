...
def main(ir_dir='./test_imgs/part321_ir', vi_dir='./test_imgs/part321_rgb', save_dir='./SeAFusion_part321', fusion_model_path='./model/Fusion/fusionmodel_final.pth'):
...
if __name__ == '__main__':
    ...
    ## dataset
    parser.add_argument('--ir_dir', '-ir_dir', type=str, default='./test_imgs/part321_ir')
    parser.add_argument('--vi_dir', '-vi_dir', type=str, default='./test_imgs/part321_rgb')
    parser.add_argument('--save_dir', '-save_dir', type=str, default='./SeAFusion_part321')
