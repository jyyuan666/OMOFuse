...
clear all;
 for i=1:300
      I_result=double(imread(strcat('MEF\Result\Y\',num2str(i),'.png')));        
      I_init_under=double(imread(strcat('MEF\Under\RGB\',num2str(i),'.png')));
      I_init_over=double(imread(strcat('MEF\Over\RGB\',num2str(i),'.png')));     
      ...
      imwrite(uint8(I_final_RGB), strcat('MEF\Result\RGB\',num2str(i),'.png')); 
  end
