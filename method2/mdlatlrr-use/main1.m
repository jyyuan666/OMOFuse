...
for kk=2:m_norm
    ...
    for k=2:m_L
        ...
        for jj=3:4
            ...
            for j=1:10
                index = j;
                path1 = ['C:\Users\Administrator\Desktop\Classic-and-state-of-the-art-image-fusion-methods-main\road\ir_572_446\',num2str(index),'.jpg'];
                
                %path1 = rgb2gray(path1)
                path2 = ['C:\Users\Administrator\Desktop\Classic-and-state-of-the-art-image-fusion-methods-main\road\Visible1_572_446_1\',num2str(index),'.jpg'];
                if is_overlap == 1
                    path_temp = './result/';
