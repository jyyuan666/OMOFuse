...
for kk=2:m_norm
    ...
    for k=2:m_L
        ...
        for jj=3:4
            ...
            for j=1:42
                index = j;
                %path1 = ['C:\Users\Administrator\Desktop\Classic-and-state-of-the-art-image-fusion-methods-main\road\ir_公开数据集\',num2str(index),'.jpg'];
                %path2 = ['C:\Users\Administrator\Desktop\Classic-and-state-of-the-art-image-fusion-methods-main\road\vi_公开数据集\',num2str(index),'.jpg'];
